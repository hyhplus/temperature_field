...
class MyFigure(FigureCanvas):
    def __init__(self, width=5, height=4, dpi=100):
        ...
        # 第三步：创建一个子图，用于绘制图形用，111表示子图编号，如matplotlib的subplot(1,1,1)
...
class MainDialogImgBW(QDialog, Ui_Dialog):
    ...
    def plotother(self):
        ...
        # 调用figure下面的add_subplot方法，类似于 matplotlib.pyplot下面的subplot方法
        x = [1, 2, 3, 4, 5, 6, 7, 8, 9]
        ...
        F1.axes3.scatter(np.random.rand(100), np.random.rand(100))
